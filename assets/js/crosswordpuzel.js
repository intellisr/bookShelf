(function($) {
    $.fn.crossword = function(quections) {
        ...
        var puzInit = {
            ...
            buildTable: function() {
                for (var i = 1; i <= rows; ++i) {
                    ...
                    for (var x = 1; x <= cols; ++x) {
                        ...
                        tbl.push('<td id="' + i + '" data-coords="' + x + ',' + i + '"></td>');
                    };
                    tbl.push("</tr>");
                };
            ...
            */
            ...
            /*
            	- Checks current entry input group 
            ...
            checkAnswer: function(e) {
                ...
                if ($('.active').hasClass('done')) {
                    ...
                    if (valToCheck === currVal) {
                        if (solvedToggle == false) {

                            correctanswer++;
                            //   alert(correctanswer);
                            document.getElementById("answert").innerHTML = correctanswer;
                        }
                        //   $('.position-' + activePosition + ' input').disabled;
